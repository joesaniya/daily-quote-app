...
class QuoteProvider with ChangeNotifier {
  ...
  Future<void> _generateDailyQuote(String dateStr) async {
    try {
      ...
      // Save as daily quote. Skip DB insert if there is no authenticated user to avoid RLS rejection.
      ...
      if (currentUser != null) {
        ...
        debugPrint('Skipping saving daily quote to DB: no authenticated user (RLS will reject anonymous inserts).');
      }
  ...
  Future<void> _generateDailyQuote(String dateStr) async {
    try {
      ...
      if (currentUser != null) {
        ...
        debugPrint(
          'Skipping saving daily quote to DB: no authenticated user (RLS will reject anonymous inserts).',
        );
      }
